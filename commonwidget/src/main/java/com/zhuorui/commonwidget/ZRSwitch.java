...
public class ZRSwitch extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        uncheckCircleWidth = optPixelSize(typedArray, R.styleable.ZRSwitch_zr_switchUncheckcircleWidth, dp2pxInt(1.5f));//dp2pxInt(1.5f);
        uncheckCircleOffsetX = dp2px(10);
        uncheckCircleRadius = optPixelSize(typedArray, R.styleable.ZRSwitch_zr_switchUncheckcircleRadius, dp2px(4));//dp2px(4);
        ...
        shadowRadius = optPixelSize(typedArray, R.styleable.ZRSwitch_zr_switchShadowRadius, dp2pxInt(2.5f));//dp2pxInt(2.5f);
        shadowOffset = optPixelSize(typedArray, R.styleable.ZRSwitch_zr_switchShadowOffset,dp2pxInt(1.5f));//dp2pxInt(1.5f);
        ...
        borderWidth = optPixelSize(typedArray, R.styleable.ZRSwitch_zr_switchBorderWidth, dp2pxInt(1));//dp2pxInt(1);
        checkLineColor = optColor(typedArray, R.styleable.ZRSwitch_zr_switchChecklineColor, Color.WHITE);//Color.WHITE;
        checkLineWidth = optPixelSize(typedArray, R.styleable.ZRSwitch_zr_switchChecklineWidth, dp2pxInt(1f));//dp2pxInt(1.0f);
        ...
        background = optColor(typedArray, R.styleable.ZRSwitch_zr_switchBackground, 0XffE5E5E5);//Color.WHITE;
