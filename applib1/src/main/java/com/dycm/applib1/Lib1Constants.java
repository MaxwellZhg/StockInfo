...
public class Lib1Constants {
    ...
    public static final String BIND = "topic.bind"; // 订阅
    public static final String UNBIND = "topic.unBind"; // 取消订阅
    public static final String UNBIND_ALL = "topic.unBindAll"; // 取消所有订阅
