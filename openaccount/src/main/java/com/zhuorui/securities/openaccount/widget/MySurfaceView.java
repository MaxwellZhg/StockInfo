...
import com.zhuorui.securities.openaccount.utils.CommonUtils;
import com.zhuorui.securities.openaccount.utils.DensityUtil;
...
public class MySurfaceView extends SurfaceView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension( DensityUtil.dip2px(context,300),  (int) screenHeight1);
    ...
    public void draw(Canvas canvas) {
        ...
        path.addCircle(widthSize / 2, height/ 2, DensityUtil.dip2px(context,139), Path.Direction.CCW);
