...
import com.zhuorui.securities.market.customer.view.kline.charts.CandleCombinedChart;
import com.zhuorui.securities.market.customer.view.kline.charts.CoupleChartGestureListener;
import com.zhuorui.securities.market.customer.view.kline.markerView.KRightMarkerView;
import com.zhuorui.securities.market.customer.view.kline.markerView.LeftMarkerView;
import com.zhuorui.securities.market.customer.view.kline.charts.MyCombinedChart;
import com.zhuorui.securities.market.customer.view.kline.dataManage.KLineDataManage;
import com.zhuorui.securities.market.customer.view.kline.enums.TimeType;
...
//        barChartData.setData(new CandleData());
    ...
    public void setMarkerView(KLineDataManage kLineData) {
        ...
        KRightMarkerView rightMarkerView = new KRightMarkerView(mContext, R.layout.layout_kline_markerview, precision);
