...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            ViewPropertyAnimatorCompat childAnim = null;
            if (holder instanceof IItemChildHolder) {
                childAnim = getOldChildViewChangeAnim((IItemChildHolder) holder);
                if (childAnim != null) {
                    childAnim.setDuration(getChangeDuration() - 10);
                    childAnim.start();
                }
            }
            ...
            ViewPropertyAnimatorCompat finalChildAnim = childAnim;
            oldViewAnim.setListener(new VpaListenerAdapter() {
                ...
                @Override
                public void onAnimationEnd(View view) {
                    if (finalChildAnim != null) {
                        finalChildAnim.cancel();
                    }
        ...
        if (newView != null) {
            ...
            ViewPropertyAnimatorCompat childAnim = null;
            if (newHolder instanceof IItemChildHolder) {
                childAnim = getNewChildViewChangeAnim((IItemChildHolder) newHolder);
                if (childAnim != null) {
                    childAnim.setDuration(getChangeDuration() - 10);
                    childAnim.start();
                }
    ...
    public interface IItemChildHolder {
        /**
         * 执行子顶动画的view
         *
         * @return
         */
        View getChildChangeAnimView();
    }
