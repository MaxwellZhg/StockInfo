...
//            JSONArray data = object.optJSONArray("data");
            ...
            for (int i = 0; i < size; i++) {
                ...
                timeDatamodel.setNowPrice(Objects.requireNonNull(fiveDayKlineData.getPrice()));
                timeDatamodel.setAveragePrice(Objects.requireNonNull(fiveDayKlineData.getAvgPrice()));
                timeDatamodel.setVolume(Objects.requireNonNull(fiveDayKlineData.getVol()));
                timeDatamodel.setOpen(Objects.requireNonNull(fiveDayKlineData.getOpenPrice()));
                timeDatamodel.setPreClose(preClose == 0 ? (preClosePrice == 0 ? timeDatamodel.getOpen() : preClosePrice) : preClose);
