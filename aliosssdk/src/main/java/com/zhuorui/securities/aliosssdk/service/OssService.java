package com.zhuorui.securities.aliosssdk.service;
...
import com.zhuorui.securities.aliosssdk.Config;
...
public class OssService {
    ...
    public OssService(Application application) {
        ...
        mOss = new OSSClient(application.getApplicationContext(), mEndpoint, credentialProvider);
    }

    public Observable getPutObjectObservable(final String uploadFilePath) {
    ...
    public Observable getPutObjectObservable(final String objectName, final String uploadFilePath) {
    ...
    public Observable getPutObjectObservable(final String objectName, final byte[] uploadData) {
        return Observable.create(new ObservableOnSubscribe() {
            @Override
            public void subscribe(ObservableEmitter emitter) throws Exception {
